...
pygame.init() 
screenMenu = pygame.display.set_mode([600,600]) 
menuOver = False
...
backgroundMenu = pygame.image.load("fondo1.gif").convert()
fingerCoor = [200,300]
...
while not menuOver:
    for event in pygame.event.get():
        ...
        #EVENTO SALIR DEL MENU
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                if fingerCoor == [200, 330]:
                    menuOver = True

        #EVENTO ENTRAR AL JUEGO
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                if fingerCoor == [200, 300]:
                    ...
                    def meteorBig():
                        for i in range(25):
                            meteorBig = MeteorBig()
                            meteorBig.rect.x = random.randrange(600)
                    ...
                    #ARCHIVOS IMPORTADOS
                    backgroundImage = pygame.image.load("espacio.jpeg").convert()
                    ...
                    while not gameOver:
                        ...
                        for laser in laserList:
                            ...
                            if len(ballList) < 13 and score > 5000:
                                powerBall(10)
    ...
    screenMenu.blit(backgroundMenu, [0, 0])
